...
<p align="center">
	<a href="https://velog.io/@junah201">
		<img src="https://img.shields.io/badge/Tech%20Blog-11B48A?style=flat-square&logo=Vimeo&logoColor=white&link=https://velog.io/@junah201"/>
	</a>&nbsp
...
<table>
	<tr>
		...
		<td align="center" width="225">
			...
			<br />
			<sub>2023/06/23 ~ 2023/07/12</sub><br />
			<sub>FastAPI, MariaDB</sub><br />
			<a
				target="_blank"
				href="https://dashboard.twitch.tv/extensions/v6llq304g93p1ud7j5k10uuvk31ttd"
			>
		...
		<td align="center" width="225">
			<a href="https://github.com/junah201/Medical-Innovation">
				<img
					src="https://yt3.googleusercontent.com/ytc/AGIKgqPf6-IoF-cxvaARmNNwJLG9fU-GEX3TRfeGeoGD=s900-c-k-c0x00ffffff-no-rj"
					width="80"
					alt=""
				/>
				<br />
			...
			<br />
			<sub>2023/01/06 ~ 2023/07/04</sub>
			<br />
			<sub>React, TypeScript, FastAPI, MySQL, Lambda, S3</sub>
			<br />
			<a target="_blank" href="https://medicalinnovation.or.kr">
		...
		<td align="center" width="225">
			...
			<br />
			<sub>2023/01/25 ~ 2023/05/15</sub>
			<br />
			<sub>Python, Lambda, API GateWay, RDS, MySQL, S3, React, TypeScript</sub>
			<br />
			<a target="_blank" href="https://runeterras.com">
	...
	<tr>
 		<td align="center" width="225">
			...
			<br />
			<sub>2022/08/13 ~ 2023/04/16</sub>
			<br />
			<sub>Python, Lambda, API GateWay, RDS, MySQL</sub>
			<br />
			<a
				target="_blank"
				href="https://chrome.google.com/webstore/detail/velog-helper/limdbpmjjehbmlnmkmaadbkklkmohbag?hl=ko"
			>
		...
		<td align="center" width="225">
			<a href="https://github.com/junah201/Twip">
				<img
					src="https://img1.daumcdn.net/thumb/R800x0/?scode=mtistory2&fname=https%3A%2F%2Fblog.kakaocdn.net%2Fdn%2FcAagJZ%2FbtqFAN1PvJN%2FS4dorkpmilhe8i22MKxZwk%2Fimg.png"
					width="80"
					alt=""
				/>
				<br />
			...
			<br />
			<sub>2022/01/25 ~ 2022/01/30</sub>
			<br />
			<sub>Python, WebSocket</sub>
			<br />
			<a target="_blank" href="https://pypi.org/project/twip-api">
				<sub>PyPi</sub>
			</a>
		</td>
		<td align="center" width="225">
			<a href="https://github.com/junah201/discord-bot-autoselfcheck">
				<img
					src="https://cdn.discordapp.com/avatars/863013480709750805/317f227174a6547266d3e17fb8369015.webp?size=80"
					width="80"
					alt=""
				/>
				<br />
			...
			<br />
			<sub>2021/05/26 ~ 2021/11/05</sub>
			<br />
			<sub>Python, Discord.py</sub>
			<br />
			<a target="_blank" href="https://koreanbots.dev/bots/863013480709750805">
				<sub>디스코드 봇 리스트</sub>
			</a>
		</td>
	</tr>
